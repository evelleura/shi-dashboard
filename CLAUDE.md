...
| 2026-06-19 | FIX | 15 | Dian minta turunin seed 2000->400 (tetap multi-tahun + 1-teknisi-1-job, contoh SPI bagus dari commit lama 200). Model supply-driven: total = N_TECHS x (span/cycle), jadi count BUKAN knob langsung. Turun count = turun N_TECHS (25->6) + lebarkan BENCH_GAP ((2,3)->(4,12)) utk atur kerapatan, span tetap 2.5thn. Hasil: 408 proyek / 6 teknisi / konkurensi=1 / SPI 0.667-2.0 variatif. Tim KECIL = benar (25 teknisi utk 400 job = nganggur). | Di model supply-driven, jumlah proyek emergent dari headcount x span/durasi. Utk target count tertentu pada span tetap: tune N_TECHS (tim) + BENCH_GAP (kerapatan), JANGAN konkurensi (langgar 1-job) atau span (langgar multi-tahun). Sweep empiris utk landing ~target. SPI/EWS logic tak disentuh -> kualitas terjaga. |
