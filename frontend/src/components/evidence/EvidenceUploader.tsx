...
export default function EvidenceUploader({ taskId, onUploadComplete }: Props) {
  ...
  return (
    <div className="space-y-3">
      {error && (
        <div className="p-2 bg-red-50 border border-red-200 rounded text-red-700 text-xs" role="alert">
          {error}
        </div>
      )}
      {success && (
        <div className="p-2 bg-green-50 border border-green-200 rounded text-green-700 text-xs" role="status">
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          className="flex-1 text-sm text-gray-500 file:mr-2 file:py-1 file:px-3 file:rounded-md file:border-0 file:text-xs file:font-medium file:bg-blue-50 file:text-blue-600 hover:file:bg-blue-100"
