    ...
    <div className="space-y-6">
      ...
      {((data.summary.open_escalations ?? 0) > 0 || (data.summary.in_review_escalations ?? 0) > 0) && (
        <button
          ...
          aria-label="Lihat eskalasi terbuka"
        >
                ...
                <div>
                  ...
                  <div className="flex gap-1.5">
                    ...
                    {clientForm.phone?.trim() && (
                      <a href={`https://wa.me/${clientForm.phone.trim().replace(/\D/g, '')}`} target="_blank" rel="noopener noreferrer" title="Hubungi via WhatsApp" className="shrink-0 flex items-center justify-center w-9 h-9 rounded-lg bg-green-500 hover:bg-green-600 transition-colors">
