#!/usr/bin/env python3
"""ERD Chen (akademik) -> drawio. Garis relasi ORTOGONAL, LURUS, sesedikit siku.

Sumber layout = diagram/erd_shi.change-this.drawio (posisi ENTITAS + ATRIBUT
DIPERTAHANKAN). Skrip menata-ulang BELAH-KETUPAT + garis relasi saja.
...
Output: diagram/erd_shi.drawio. Jalankan ulang tiap change-this.drawio diubah.
"""
import xml.etree.ElementTree as ET
from collections import defaultdict

SRC = r"D:\__CODING\personal\_gf\irene\shi-crm\diagram\erd_shi.change-this.drawio"
...
for cell, s, t in edge_cells:
    if s in diamonds and t in ename: dents[s].append((cell, t))
